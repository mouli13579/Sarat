...
namespace APIServices.Controllers
{
    public class UsersController : ApiController
    {
        ...
        public DataTable GetUsersList()
        {
            ...
            ret = new DataLayer.Users().GetUsersList();
        ...
        public string CreateUser([FromBody] Models.Users objUser)
        {
            ...
            if (userID > 0)
            {
                AutoGeneratedMailsController au = new AutoGeneratedMailsController();
                au.SendRegistrationEmail(objUser.Email,objUser.FirstName);
